...
#
# Single Topic Edition! Meant to be used in a distributed manner, probably in a Docker
# container. Takes in an environment variable REINVENT_TOPIC_ID which specifies which
# re:Invent Topic to pull from.
#
# Requirements:
